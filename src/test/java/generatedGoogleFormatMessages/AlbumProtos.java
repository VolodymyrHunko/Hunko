...
// source: definedGoogleFormatMessages/albom.proto
...
public final class AlbumProtos {
  ...
  public interface AlbumOrBuilder extends
    ...
    /**
     * <code>optional int32 release_year = 3;</code>
     */
    int getReleaseYear();
  ...
  public  static final class Album extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return generatedGoogleFormatMessages.AlbumProtos.internal_static_Album_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return generatedGoogleFormatMessages.AlbumProtos.internal_static_Album_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              generatedGoogleFormatMessages.AlbumProtos.Album.class, generatedGoogleFormatMessages.AlbumProtos.Album.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof generatedGoogleFormatMessages.AlbumProtos.Album)) {
        return super.equals(obj);
      }
      generatedGoogleFormatMessages.AlbumProtos.Album other = (generatedGoogleFormatMessages.AlbumProtos.Album) obj;
    ...
    public static generatedGoogleFormatMessages.AlbumProtos.Album parseFrom(
    ...
    public static generatedGoogleFormatMessages.AlbumProtos.Album parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static generatedGoogleFormatMessages.AlbumProtos.Album parseFrom(
    ...
    public static generatedGoogleFormatMessages.AlbumProtos.Album parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static generatedGoogleFormatMessages.AlbumProtos.Album parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static generatedGoogleFormatMessages.AlbumProtos.Album parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(generatedGoogleFormatMessages.AlbumProtos.Album prototype) {
    ...
    public static final class Builder extends
        ...
        generatedGoogleFormatMessages.AlbumProtos.AlbumOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return generatedGoogleFormatMessages.AlbumProtos.internal_static_Album_descriptor;
      }
      ...
      // Construct using generatedGoogleFormatMessages.AlbumProtos.Album.newBuilder()
      private Builder() {
      ...
      public generatedGoogleFormatMessages.AlbumProtos.Album getDefaultInstanceForType() {
        return generatedGoogleFormatMessages.AlbumProtos.Album.getDefaultInstance();
      }

      public generatedGoogleFormatMessages.AlbumProtos.Album build() {
        generatedGoogleFormatMessages.AlbumProtos.Album result = buildPartial();
      ...
      public generatedGoogleFormatMessages.AlbumProtos.Album buildPartial() {
        generatedGoogleFormatMessages.AlbumProtos.Album result = new generatedGoogleFormatMessages.AlbumProtos.Album(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof generatedGoogleFormatMessages.AlbumProtos.Album) {
          return mergeFrom((generatedGoogleFormatMessages.AlbumProtos.Album)other);
        } else {
      ...
      public Builder mergeFrom(generatedGoogleFormatMessages.AlbumProtos.Album other) {
        if (other == generatedGoogleFormatMessages.AlbumProtos.Album.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        generatedGoogleFormatMessages.AlbumProtos.Album parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (generatedGoogleFormatMessages.AlbumProtos.Album) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final generatedGoogleFormatMessages.AlbumProtos.Album DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new generatedGoogleFormatMessages.AlbumProtos.Album();
    }

    public static generatedGoogleFormatMessages.AlbumProtos.Album getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\'definedGoogleFormatMessages/albom.prot" +
      "o\"P\n\005Album\022\r\n\005title\030\001 \001(\t\022\016\n\006artist\030\002 \003(" +
      "\t\022\024\n\014release_year\030\003 \001(\005\022\022\n\nsong_title\030\004 " +
      "\003(\tB,\n\035generatedGoogleFormatMessagesB\013Al" +
      "bumProtosb\006proto3"
    };
